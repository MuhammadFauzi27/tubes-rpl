...
export const up = (pgm) => {
  ...
  pgm.sql("COMMENT ON COLUMN tables.qr_code_token IS 'Token yang diencode ke QR code, digunakan pelanggan untuk scan. Bisa di-regenerate via POST /tables/{id}/regenerate-qr'");
